...
Config.Elevators = {
	...
	SkybarElevatorNorth = {
		{
			coords = vector3(-118.25, -608.39, 36.28), heading = 72.02, level = "Skybar Ground", label = "Ground Level",
		},
		{
			coords = vector3(-161.25, -585.84, 192.21), heading = 333.79, level = "Skybar 5th Floor", label = "Skye bar", 
		},
	},

	SkybarElevatorWest = {
		{
			coords = vector3(3561.26, 3689.25, 28.12), heading = 82.96, level = "Medical Lab", label = "3rd Floor",
		},
		{
